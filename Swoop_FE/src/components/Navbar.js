      ...
      <Box sx={{ flexGrow: 1 }}>
        <AppBar position='static' >
          <Toolbar sx={{ background: 'white', color: 'black', justifyContent: 'space-between' }}>
            ...
            <Stack sx={{ display: { xs: 'block', sm: 'flex' } }} direction={{ xs: 'column', sm: 'row' }} spacing={{ xs: 0, sm: 2 }} >
              {isAuthenticated ?
                (<>
                  <IconButton
                    size='large'
                ...
                (<>
                  ...
                  <Button variant='contained' sx={{ display: { xs: 'none', md: 'block' } }} onClick={()=>navigate('/Register')}>
                    Register
                  </Button>
                  {/* <Register setIsAuthenticated={setIsAuthenticated} /> */}
                  <Button variant='contained' sx={{ display: { xs: 'none', md: 'block' } }} onClick={() => navigate('/Login')}>
                    Login
                  </Button>
              ...
              <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex', justifyContent: 'center' } }}>
                {pages.map((page) => (
                  ...
                  <Button
                    ...
                    value={page}
                    onClick={handleFilterCategory}
                    sx={{ my: 2, color: 'white', backgroundColor: page===selected? '#82454a' : 'primary', display: 'block', marginRight: 5 }}
                  >
                    {page}
                  </Button>
