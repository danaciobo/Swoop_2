...
export default function EditItem({ setItems, setFilteredItems, items, item }) {
  ...
  const handleSubmit = (e) => {
    ...
    const formData = {title, description, price, quantity, location, category}
  ...
  return (
    <div>
      <Button variant='contained' p={0} sx={{fontSize: 12, padding:0}} size='small' onClick={handleClickOpen} disableElevation>
        Edit
      </Button>
        ...
        <DialogContent>
          ...
          >
            ...
            <div display='flex' flexDirection='rows'>
              ...
              <TextField
                sx={{ width: {xs: '4.5em', sm: '9.5em'}, marginBottom: '0.7em' }}
                label='Location'
                variant='outlined'
                required
                value={location}
